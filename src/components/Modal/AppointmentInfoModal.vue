          ...
          >
            ...
            >
              ...
              <div
                ...
                <p>Time: {{appointment.startDateTime.getHours()}}:{{appointment.startDateTime.getMinutes()}} - {{appointment.endDateTime.getHours()}}:{{appointment.endDateTime.getMinutes()}}</p>
                <p>Confirmed: {{appointment.confirmed ? 'Yes' : 'No'}}</p>
                <p>Notes: {{appointment.notes}}</p>
              </div>
              <div class="px-4 justify-end py-3 flex space-x-3 border-t border-slate-100 dark:border-slate-700">
                <DashButton
                    class="mr-auto"
