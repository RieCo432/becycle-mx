...
def build_contract_expiry_reminder_email(contract: schemas.Contract):
    return ("<html>"
            "   <body>"
            "       <h2 style='color:#ff0000'>Your Contract is due to expire soon. Please visit us with your bike to return it, or extend the contract!</h2>"
            "       <h2>Your Details</h2>"
            "       <p>{:s} {:s}</p>"
            "       <h2>Bike Details</h2>"
            "       <p>{:s} {:s}</p>"
