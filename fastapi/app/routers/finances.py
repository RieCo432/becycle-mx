...
@finances.get("/finances/deposits/claimable")
...
@finances.get("/finances/deposits/returned")
...
@finances.get("/finances/deposits/flow")
...
@finances.get("/finances/deposits/status")
...
@finances.get("/finances/deposits/return-percentage")
...
@finances.get("/finances/deposits/required-float/worst-case")
...
@finances.get("/finances/deposits/required-float/realistic")
...
@finances.get("/finances/cashflow/actual")
...
@finances.get("/finances/cashflow/provisional")
...
@finances.get("/finances/cashflow/total")
