...
export const topMenu = [
  ...
  },
  {
    ...
    icon: 'material-symbols:mobile-theft',
    link: '/crimereports',
    show: ['user'],
  },
  {
  ...
  },
  {
    ...
    child: [
      ...
      {
        childtitle: 'Expenses',
        childicon: 'heroicons-outline:receipt-refund',
  ...
  },
  {
    ...
    child: [
      ...
      {
        childtitle: 'Accounts',
        childicon: 'material-symbols:wallet',
        childlink: '/admin/accounts',
        show: ['user'],
      },
      {
        childtitle: 'Sale Catalogue',
      ...
      },
      {
        ...
        childicon: 'material-symbols:pedal-bike-outline',
